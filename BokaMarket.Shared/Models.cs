...
public class Product
{
    ...
    public bool IsNewlyAdded { get; set; } = false; // For notifications
}
...
{
    public int Id { get; set; } // Added for persistence
...
{
    public int Id { get; set; } // Key for settings
    public string StoreName { get; set; } = "Boka Yarn Market";
